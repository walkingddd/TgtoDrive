...
<p align="center">
<strong>全能型网盘助手：支持115、123云盘自动分类整理，支持 Telegram 频道监控、多网盘（123/115/天翼/夸克）自动转存、全网视频下载（B站/抖音）、WebSSH终端、以及各类资源的秒传与直链播放。</strong>
</p>
...
* **基础支持**：转存123 / 115 / 天翼云盘链接，解锁并转存影巢链接。
...
* **多协议离线下载**：
* **磁力链 (Magnet)**：发送给机器人，自动提交至 123 或 115离线列表。
* **电驴 (ed2k)**：发送给机器人，自动提交至 115 离线列表。
* **Torrent 文件**：直接发送 `.torrent` 种子文件给机器人，自动提交至 123 或 115离线。
